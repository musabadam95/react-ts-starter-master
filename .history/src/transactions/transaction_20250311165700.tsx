...
const Transactions = () => {
    ...
    function convertDate(date: string) {
        ...
        console.log(transactionDate.toLocaleTimeString('en-GB', { hour: "2-digit", minute: "2-digit" } ));

        console.log(transactionDate.toLocaleString('en-GB', ));

return transactionDate.toLocaleTimeString('en-GB' ) + ' ' + transactionDate.toLocaleDateString('en-GB' );
    }   
